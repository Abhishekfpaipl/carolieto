<template>
    <div class="my-5 py-5 pb-md-0" style="background-color:#f3f8f3 !important ">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-8 mt-5 mt-md-0">
                    ...
                    <button class="btn btn-dark my-5 fs-4" data-bs-toggle="modal" data-bs-target="#exampleModal" >Enquiry Now</button>
                </div>
            </div>
        </div>
    </div>
